import { DbStaff, DbRole, DbShiftDefinition, DbRoster, DbStaffAvailability, StaffGroup } from './types';
...
// UPDATED: New Staff List (11 People)
export const DB_STAFF: DbStaff[] = [
  ...
  { staff_id: 10, first_name: 'NAN', last_name: '', is_active: 1 },
  { staff_id: 11, first_name: 'AMM', last_name: '', is_active: 1 }
];

// --- Kitchen / Floor split ---
// Starting point only: dragging a row across the divider in the timetable
// reassigns that person, and the change is saved to the shared store.
export const STAFF_GROUP_LABELS: Record<StaffGroup, string> = {
  kitchen: 'Kitchen',
  floor: 'Floor'
};

export const DEFAULT_STAFF_GROUPS: Record<string, StaffGroup> = {
  1: 'kitchen',  // LINNA
  2: 'kitchen',  // NAT
  3: 'kitchen',  // TAN
  9: 'kitchen',  // PANG
...
// Kitchen above the line, Floor below, each in staff_id order.
export const DEFAULT_STAFF_ORDER: number[] = [1, 2, 3, 9, 10, 11, 4, 5, 6, 7, 8];
